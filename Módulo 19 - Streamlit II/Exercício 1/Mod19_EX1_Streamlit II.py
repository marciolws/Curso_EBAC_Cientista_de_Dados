...
def main():
    st.set_page_config(
        ...
        page_icon="https://raw.githubusercontent.com/marciolws/EBAC_EXERCICIOS/refs/heads/main/Módulo%2019%20-%20Streamlit%20II/data/telmarketing_icon.png",
        layout="wide",
    ...
    # SIDEBAR
    image = Image.open(
        fp='https://raw.githubusercontent.com/marciolws/EBAC_EXERCICIOS/refs/heads/main/Módulo%2019%20-%20Streamlit%20II/data/Bank-Branding.jpg')
    st.sidebar.image(image=image)

    # TÍTULO
    st.markdown('''
    <div style="text-align:center">
        <a href="https://github.com/marciolws/EBAC_EXERCICIOS">
            <img src="https://raw.githubusercontent.com/marciolws/EBAC_EXERCICIOS/refs/heads/main/EBAC-media-utils/logo/ebac_logo-data_science.png" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Data:** 4 de maio de 2023.
    ...
    bank_raw = load_data(
        file_data='https://raw.githubusercontent.com/marciolws/EBAC_EXERCICIOS/refs/heads/main/Módulo%2019%20-%20Streamlit%20II/data/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
